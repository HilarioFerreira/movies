...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMoviesService.class);
	...
	{
		return DefaultMoviesService.class.getResourceAsStream("/movies/sap-hybris-platform.png");
	}
